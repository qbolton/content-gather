<?php
/**
 * Define base database functionality for the cg_raw_posts table 
 *
 * Defines the base CgRawPosts class 
 *
 */

/**
 * CgRawPostsTable base class
 */
class CgRawPostsTable extends DBTable {
	/** 
	 * @access protected
	 * @var string String that contains the table name unto which the SQL operations will be applied
	 */
	protected $TABLENAME = "cg_raw_posts";	
	...
	protected $COLUMNINFO = array(
	          ...
	          array('name'=>'post_status','primary_key'=>FALSE,'data_type'=>'int','max_length'=>'','numeric_precision'=>'10','default'=>'0','is_nullable'=>'NO'),
	          ...
	          array('name'=>'post_comment_url','primary_key'=>FALSE,'data_type'=>'varchar','max_length'=>'255','numeric_precision'=>'','default'=>'','is_nullable'=>'YES'),
	          ...
	          array('name'=>'post_tags','primary_key'=>FALSE,'data_type'=>'text','max_length'=>'65535','numeric_precision'=>'','default'=>'','is_nullable'=>'YES'),
	          ...
	          array('name'=>'post_image','primary_key'=>FALSE,'data_type'=>'text','max_length'=>'65535','numeric_precision'=>'','default'=>'','is_nullable'=>'YES'),
	          array('name'=>'post_video','primary_key'=>FALSE,'data_type'=>'text','max_length'=>'65535','numeric_precision'=>'','default'=>'','is_nullable'=>'YES'),
	...
	/**
	 * Contructor for CgRawPostsTable class
	 *
	 * @access public
